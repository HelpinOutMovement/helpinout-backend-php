...
//phpinfo(); exit;
$base_url = 'http://3.7.52.176:8080';
$url = $base_url . '/api/v1/user/emailoffermapping';
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $data_string = '{ "app_id": "533", "imei_no": "d31f70e57896db2b", "app_version": "1.0", "date_time": "2020-05-06T19:50:47.910+05:30", "data": { "email_address": "vikas.k.c@gmail.com" } }';
...
<html>
    <head>
        <title>Api Check - User Login</title>
        <meta charset="UTF-8">
    ...
    <body>
        <form  method="POST">
            ...
            <br/>
            os_type<input type="text" name="os_type"/><br/>
            manufacturer_name<input type="text" name="manufacturer_name"/><br/>
            os_version<input type="text" name="os_version"/><br/>
            firebase_token<input type="text" name="firebase_token"/><br/>
            app_version<input type="text" name="app_version"/><br/>
            time_zone<input type="text" name="time_zone"/><br/>

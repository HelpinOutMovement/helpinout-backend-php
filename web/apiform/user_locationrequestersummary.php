...
//phpinfo(); exit;
//$base_url = 'http://3.7.52.176:8080';
$url = $base_url . '/api/v1/user/locationrequestersummary';
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    "app_version": "1.0",
    "date_time": "2020-04-17T13:37:32.055+05:30",
    "data": {
        "geo_location": "28.6442682,77.3617642",
        "geo_accuracy": "24.631",
        "radius": 52227.305
    }
}' ;
...
<html>
    ...
    <body>
        <form  method="POST">
            ...
            mobile_no_visibility<input type="text" name="mobile_no_visibility"/><br/>

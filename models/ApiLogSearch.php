...
//    }
    ...
    public function rules() {
        return [
            ...
            [['app_user_id', 'app_version', 'app_option', 'version_no', 'imei_no', 'ip', 'time', 'request_body', 'request_url', 'response', 'mobile', 'app_registration_id'], 'safe'],
        ];
    }
    ...
    public function search($params, $user_model = null, $pagination = true) {
        $query = ApiLog::find()->joinWith(['appdetail', 'appuser']);
        ...
        $query->andFilterWhere([
            ...
            'api_log.app_registration_id' => $this->app_registration_id,
            //   'app_detail.user_id'=>$this->user_id,
            'app_registration.app_version' => $this->app_version,
        ]);
        if (isset($_GET['mobile_no'])) {
            $query->andFilterWhere(['like', 'app_user.mobile_no', $_GET['mobile_no']]);
        }else{
             $query->andFilterWhere(['like', 'app_user.mobile_no', $this->mobile]);
        }

 ...
 * @property string $request_time_zone_offset
...
class ApiLog extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ip', 'request_datetime', 'request_time_zone_offset', 'request_url', 'api_response_message', 'created_at'], 'required'],
            [['request_datetime', 'request_time_zone_offset'], 'safe'],
            [['request_body', 'response'], 'string'],
            [['app_registration_id', 'http_response_code', 'api_response_status', 'created_at'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'request_time_zone_offset' => 'Request Time Zone',
